...
/**
 * Generates thumbnail of image with specific width size
 * @param {String} filePath The location of original file
...
userQueue.process(async (job, done) => {
  ...
  try {
    const mailSubject = 'ALX-Files_Manager project by stormshadow96';
    const mailContent = [
      '<div>',
      '<h3>Hello {{user.name}},</h3>',
      'Welcome to <a href="https://github.com/stormshadow96/alx-files_manager">',
      'ALX-Files_Manager</a>, ',
      'a simple file management API built with Node.js by ',
      '<a href="https://github.com/stormshadow96">Thato Letsoalo</a>. ',
      'Happy codng!',
      '</div>',
    ].join('');
